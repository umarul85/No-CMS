...
/**
 * Description of Manage_donate
 *
 * @author No-CMS Module Generator
 */
class Manage_donate extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'donate';
    protected $COLUMN_NAMES = array('donator_name', 'center_name', 'item');
    protected $PRIMARY_KEY = 'donate_id';
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Donate');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('donator_name', 'center_name', 'item');
        //$crud->edit_fields('donator_name', 'center_name', 'item', '_updated_by', '_updated_at');
        //$crud->add_fields('donator_name', 'center_name', 'item', '_created_by', '_created_at');
        //$crud->set_read_fields('donator_name', 'center_name', 'item');
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->required_fields('center_name');
        ...
        ////////////////////////////////////////////////////////////////////////
        $crud->set_relation('center_name', $this->t('center'), 'center_name');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_donate_view', $output,
            $this->n('manage_donate'), $config);
    }


    // returned on insert and edit
    public function _callback_field_item($value, $primary_key){
        ...
        $lookup_config_list = array(
            'center_id' => array(
                'selection_table'         => 'center',
                'selection_pk_column'     => 'center_id',
                'selection_lookup_column' => 'center_name',
            ),
            'item_name' => array(
                'selection_table'         => 'item',
                'selection_pk_column'     => 'item_id',
                'selection_lookup_column' => 'item_name',
            ),
            'item_type' => array(
                'selection_table'         => 'item_type',
        ...
        return $this->load->view($this->cms_module_path().'/field_donate_item',$data, TRUE);
    }

    // returned on view
    public function _callback_column_item($value, $row){
        return $this->_humanized_record_count(
                'inventory', // DETAIL TABLE NAME
                'inventory_id', // DETAIL FK NAME
                $row->donate_id, // CURRENT TABLE PK VALUE
                array( // CAPTIONS
                    'single_caption'    => 'Inventory',
                    'multiple_caption'  => 'Inventorys',
                    'zero_caption'      => 'No Inventory',
                )
            );
    }
    ...
    public function _after_insert_or_update($post_array, $primary_key){
        // SAVE CHANGES OF inventory
        $data = json_decode($this->input->post('md_real_field_item_col'), TRUE);
        $this->_save_one_to_many(
            'item', // FIELD NAME
            'inventory', // DETAIL TABLE NAME
            'inventory_id', // DETAIL PK NAME
            'inventory_id', // DETAIL FK NAME
