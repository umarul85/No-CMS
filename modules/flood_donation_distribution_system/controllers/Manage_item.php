...
/**
 * Description of Manage_item
 *
 * @author No-CMS Module Generator
 */
class Manage_item extends CMS_CRUD_Controller {
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_item_view', $output,
            $this->n('manage_item'), $config);
    }
