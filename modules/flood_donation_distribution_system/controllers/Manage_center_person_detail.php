...
/**
 * Description of Manage_center_person_detail
 *
 * @author No-CMS Module Generator
 */
class Manage_center_person_detail extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'center_person_detail';
    protected $COLUMN_NAMES = array('center_id', 'person_id', 'priority');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Center Person Detail');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('center_id', 'person_id', 'priority');
        //$crud->edit_fields('center_id', 'person_id', 'priority', '_updated_by', '_updated_at');
        //$crud->add_fields('center_id', 'person_id', 'priority', '_created_by', '_created_at');
        //$crud->set_read_fields('center_id', 'person_id', 'priority');

        // caption of each columns
        $crud->display_as('center_id','Center Id');
        $crud->display_as('person_id','Person Id');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_center_person_detail_view', $output,
            $this->n('manage_center_person_detail'), $config);
    }
