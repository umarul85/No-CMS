...
/**
 * Description of Manage_item_type
 *
 * @author No-CMS Module Generator
 */
class Manage_item_type extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'item_type';
    protected $COLUMN_NAMES = array('item_type');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Type Of Item Detail');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('item_type');
        //$crud->edit_fields('item_type', '_updated_by', '_updated_at');
        //$crud->add_fields('item_type', '_created_by', '_created_at');
        //$crud->set_read_fields('item_type');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_item_type_view', $output,
            $this->n('manage_item_type'), $config);
    }
