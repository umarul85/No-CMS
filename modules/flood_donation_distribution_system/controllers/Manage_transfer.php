...
/**
 * Description of Manage_transfer
 *
 * @author No-CMS Module Generator
 */
class Manage_transfer extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'transfer';
    protected $COLUMN_NAMES = array('item_name');
    protected $PRIMARY_KEY = 'transfer_id';
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Transfer Item To Other');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('item_name');
        //$crud->edit_fields('item_name', '_updated_by', '_updated_at');
        //$crud->add_fields('item_name', '_created_by', '_created_at');
        //$crud->set_read_fields('item_name');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_transfer_view', $output,
            $this->n('manage_transfer'), $config);
    }


    // returned on insert and edit
    public function _callback_field_item_name($value, $primary_key){
        ...
        return $this->load->view($this->cms_module_path().'/field_transfer_item_name',$data, TRUE);
    }

    // returned on view
    public function _callback_column_item_name($value, $row){
        return $this->_humanized_record_count(
                'inventory', // DETAIL TABLE NAME
                'inventory_id', // DETAIL FK NAME
                $row->transfer_id, // CURRENT TABLE PK VALUE
                array( // CAPTIONS
    ...
    public function _after_insert_or_update($post_array, $primary_key){
        ...
        $data = json_decode($this->input->post('md_real_field_item_name_col'), TRUE);
