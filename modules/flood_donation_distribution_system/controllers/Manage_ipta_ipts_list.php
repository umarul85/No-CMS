...
/**
 * Description of Manage_ipta_ipts_list
 *
 * @author No-CMS Module Generator
 */
class Manage_ipta_ipts_list extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'IPTA_IPTS_list';
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('IPTA/IPTS List');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_ipta_ipts_list_view', $output,
            $this->n('manage_ipta_ipts_list'), $config);
    }
