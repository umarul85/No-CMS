...
class Browse_inventory extends CMS_Secure_Controller {
    ...
    public function index(){
        ...
        $data = array(
            ...
            'backend_url'               => site_url($this->cms_module_path().'/manage_inventory/index'),
            'module_path'               => $this->cms_module_path(),
            'first_data'                => Modules::run($module_path.'/browse_inventory/get_data', 0, '')
        );
        $this->view($this->cms_module_path().'/Browse_inventory_view',$data,
    ...
    public function get_data($page = 0, $keyword = ''){
        ...
        // get data from model
        $this->load->model($this->cms_module_path().'/inventory_model');
