...
/**
 * Description of Manage_flood_victim_detail
 *
 * @author No-CMS Module Generator
 */
class Manage_flood_victim_detail extends CMS_CRUD_Controller {
    ...
    protected function make_crud(){
        ...
        $crud->display_as('victim_status','Victim Status');
        $crud->display_as('victim_enter_date','Victim Enter Date');
        $crud->display_as('victim_out_date','Victim Out Date');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_flood_victim_detail_view', $output,
            $this->n('manage_flood_victim_detail'), $config);
    }
