...
/**
 * Description of Manage_inventory
 *
 * @author No-CMS Module Generator
 */
class Manage_inventory extends CMS_CRUD_Controller {
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_inventory_view', $output,
            $this->n('manage_inventory'), $config);
    }
