...
/**
 * Description of Manage_inventory_transfer
 *
 * @author No-CMS Module Generator
 */
class Manage_inventory_transfer extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'inventory_transfer';
    protected $COLUMN_NAMES = array('transfer_id', 'inventory_id', 'priority');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Inventory Transfer');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('transfer_id', 'inventory_id', 'priority');
        //$crud->edit_fields('transfer_id', 'inventory_id', 'priority', '_updated_by', '_updated_at');
        //$crud->add_fields('transfer_id', 'inventory_id', 'priority', '_created_by', '_created_at');
        //$crud->set_read_fields('transfer_id', 'inventory_id', 'priority');

        // caption of each columns
        $crud->display_as('transfer_id','transfer_id');
        $crud->display_as('inventory_id','Inventory Id');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_inventory_transfer_view', $output,
            $this->n('manage_inventory_transfer'), $config);
    }
