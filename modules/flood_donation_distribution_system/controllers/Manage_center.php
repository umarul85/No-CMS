...
class Manage_center extends CMS_CRUD_Controller {
    ...
    protected function make_crud(){
        ...
        $crud->display_as('residing_address','Residing Address');
        $crud->display_as('city','City');
        $crud->display_as('postal_code','Postal Code');
        $crud->display_as('state_region','State/Region');
        $crud->display_as('center_type','Center Type');
        $crud->display_as('center_total_capacity','Center Total Capacity');
        $crud->display_as('center_current_cappacity','Center Current Cappacity');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_center_view', $output,
            $this->n('manage_center'), $config);
    }
