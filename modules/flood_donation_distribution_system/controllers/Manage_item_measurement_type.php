...
/**
 * Description of Manage_item_measurement_type
 *
 * @author No-CMS Module Generator
 */
class Manage_item_measurement_type extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'item_measurement_type';
    protected $COLUMN_NAMES = array('item_measurement');
    protected $PRIMARY_KEY = 'measurement_id';
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('Item Measurement Type');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('item_measurement');
        //$crud->edit_fields('item_measurement', '_updated_by', '_updated_at');
        //$crud->add_fields('item_measurement', '_created_by', '_created_at');
        //$crud->set_read_fields('item_measurement');

        // caption of each columns
        $crud->display_as('item_measurement','Item Measurement');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_item_measurement_type_view', $output,
            $this->n('manage_item_measurement_type'), $config);
    }
