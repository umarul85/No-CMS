...
<script type="text/javascript">
    var PAGE                   = 1;
    var URL                    = '<?php echo site_url($module_path."/browse_inventory/get_data"); ?>';
    ...
    function fetch_more_data(async){
        ...
        $('#record_content_bottom').html('Load more Inventory &nbsp;<img src="{{ BASE_URL }}assets/nocms/images/ajax-loader.gif" />');
        ...
        REQUEST = $.ajax({
            ...
            'success'  : function(response){
                ...
                var bottom_content = 'No more Inventory to show.';
                if(ALLOW_NAVIGATE_BACKEND && HAVE_ADD_PRIVILEGE){
