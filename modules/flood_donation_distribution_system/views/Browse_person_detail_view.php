...
<script type="text/javascript">
    var PAGE                   = 1;
    var URL                    = '<?php echo site_url($module_path."/browse_person_detail/get_data"); ?>';
    ...
    function fetch_more_data(async){
        ...
        $('#record_content_bottom').html('Load more Person Detail &nbsp;<img src="{{ BASE_URL }}assets/nocms/images/ajax-loader.gif" />');
        ...
        REQUEST = $.ajax({
            ...
            'success'  : function(response){
                ...
                var bottom_content = 'No more Person Detail to show.';
                if(ALLOW_NAVIGATE_BACKEND && HAVE_ADD_PRIVILEGE){
