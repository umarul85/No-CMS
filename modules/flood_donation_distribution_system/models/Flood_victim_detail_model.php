...
class Flood_victim_detail_model extends  CMS_Model{
    ...
    public function get_data($keyword, $page=0){
        $limit = 10;
        $query = $this->db->select('flood_victim_detail.victim_id, center.center_name as center_center_name, flood_victim_detail.victim_name, flood_victim_detail.victim_ic, flood_victim_detail.gender, flood_victim_detail.age, flood_victim_detail.contact_number, flood_victim_detail.home_address, flood_victim_detail.city, flood_victim_detail.postal_code, flood_victim_detail.state_region, flood_victim_detail.current_ipta_ipts, flood_victim_detail.victim_status, flood_victim_detail.victim_enter_date, flood_victim_detail.victim_out_date')
            ...
            ->or_like('flood_victim_detail.victim_ic', $keyword)
