...
/**
 * Description of Manage_city_commodity
 *
 * @author No-CMS Module Generator
 */
class Manage_city_commodity extends CMS_CRUD_Controller {

    protected $URL_MAP = array();
    protected $TABLE_NAME = 'city_commodity';
    protected $COLUMN_NAMES = array('city_id', 'commodity_id', 'priority');
    ...
    protected function make_crud(){
        ...
        // set subject
        $crud->set_subject('City Commodity');

        // displayed columns on list, edit, and add, uncomment to use
        //$crud->columns('city_id', 'commodity_id', 'priority');
        //$crud->edit_fields('city_id', 'commodity_id', 'priority', '_updated_by', '_updated_at');
        //$crud->add_fields('city_id', 'commodity_id', 'priority', '_created_by', '_created_at');
        //$crud->set_read_fields('city_id', 'commodity_id', 'priority');

        // caption of each columns
        $crud->display_as('city_id','City Id');
        $crud->display_as('commodity_id','Commodity Id');
        ...
        $crud->set_relation('commodity_id', $this->t('commodity'), 'name');
    ...
    public function index(){
        ...
        // show the view
        $this->view($this->cms_module_path().'/Manage_city_commodity_view', $output,
            $this->n('manage_city_commodity'), $config);
    }
